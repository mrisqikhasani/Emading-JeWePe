    ...
    <script src="../assets/trumbowyg/dist/plugins/pasteimage/trumbowyg.pasteimage.min.js"></script>
    <script src="../assets/trumbowyg/dist/plugins/allowtagsfrompaste/trumbowyg.allowtagsfrompaste.min.js"></script>

    <script>
      $('#trumbowyg-demo').trumbowyg();
      $('#trumbowyg-demo').trumbowyg({
        btns: [['strong', 'em', 'fontfamily'], ['insertImage']],
        autogrow: true
      });
    </script>
  </body>
